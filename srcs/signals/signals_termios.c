...
/*   Updated: 2025/04/03 12:25:30 by mosokina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
This function modifies the terminal settings to enable or disable the ECHOCTL flag. 
The ECHOCTL flag in terminal settings controls whether control characters are echoed as visible characters. 
When ECHOCTL is enabled, control characters (like Ctrl+C and CTRL+\) are displayed as ^C and ^\ in the terminal. 
...
/*
This function modifies the terminal settings to enable or disable the ICANON and ECHO flag. 
ICANON: This flag enables canonical mode, where input is processed line by line. 
In canonical mode, input is buffered until a newline character is received, 
